...
use crate::layer_old::bvh::{ChunkBvh, GetChunkPos};
use crate::ChunkView;
    ...
    L: Clone + Ord + GetChunkPos,
{
    ...
    pub(crate) fn insert_local<E>(&mut self, msg: L, rev_idx: usize, f: impl FnOnce(&mut Vec<u8>) -> Result<(), E>) -> Result<(), E> {
        debug_assert!(!self.is_ready);
        ...
        self.local.insert(self.local.len() - rev_idx, (msg, start as u32..end as u32));
