...
pub use valence_protocol::{
    ...
    CompressionThreshold, Difficulty, Direction, GameMode, Hand, Ident, ItemKind, ItemStack,
    StatusEffect, StatusEffectCategory, Text, MINECRAFT_VERSION, PROTOCOL_VERSION,
};
