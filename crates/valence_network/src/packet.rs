...
#[packet(id = packet_id::HANDSHAKE_C2S)]
...
#[packet(id = packet_id::QUERY_PING_C2S)]
pub struct QueryPingC2s {
    pub payload: u64,
}

#[derive(Copy, Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::QUERY_REQUEST_C2S)]
...
#[derive(Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_HELLO_C2S)]
...
#[derive(Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_KEY_C2S)]
...
#[derive(Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_QUERY_RESPONSE_C2S)]
...
#[derive(Copy, Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_COMPRESSION_S2C)]
pub struct LoginCompressionS2c {
    pub threshold: VarInt,
}

#[derive(Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_DISCONNECT_S2C)]
pub struct LoginDisconnectS2c<'a> {
    pub reason: Cow<'a, Text>,
}

#[derive(Copy, Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_HELLO_S2C)]
...
#[derive(Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_QUERY_REQUEST_S2C)]
...
#[derive(Clone, Debug, Encode, Decode, Packet)]
#[packet(id = packet_id::LOGIN_SUCCESS_S2C)]
